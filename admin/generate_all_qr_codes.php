            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div id="codePreview" class="text-center mb-3" style="min-height: 200px; padding: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <?php if($absolute_path && file_exists($absolute_path) && filesize($absolute_path) > 0): 
                            // Get file info
                            $file_info = getimagesize($absolute_path);
                            $file_size_kb = round(filesize($absolute_path) / 1024, 2);
                        ?>
                            <img src="<?php echo htmlspecialchars($web_path); ?>" 
                                 ...
                                 onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"200\" height=\"200\"><rect width=\"100%\" height=\"100%\" fill=\"#f8f9fa\"/><text x=\"50%\" y=\"50%\" text-anchor=\"middle\" dy=\".3em\" fill=\"#6c757d\">QR Code Error</text></svg>';">
                            <p class="mt-2"><strong><?php echo htmlspecialchars($preview_data); ?></strong></p>
                            <small class="text-muted"><?php echo $file_info[0] . '×' . $file_info[1] . ' px • ' . $file_size_kb; ?> KB</small>
        ...
        <body>
            <div class="page-container">
                ...
                <div class="qr-container">
                    <img src="${qrImagePath}" alt="QR Code ESP32" onerror="this.onerror=null; this.src='data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"250\" height=\"250\"><rect width=\"100%\" height=\"100%\" fill=\"#f8f9fa\"/><text x=\"50%\" y=\"50%\" text-anchor=\"middle\" dy=\".3em\" fill=\"#6c757d\">QR Code</text></svg>';">
                </div>
